...
class SliderAdapter(imageUrl: ArrayList<String>) :
    ...
    override fun onBindViewHolder(viewHolder: SliderAdapter.SliderViewHolder?, position: Int) {
        ...
        if (viewHolder != null) {
            ...
            // loading the image inside our image view using glide library
                val end = sliderList.lastIndex
            if (position == end) {
                viewHolder.BtnLanjut.visibility = View.VISIBLE

                viewHolder.BtnLanjut.setOnClickListener {
    ...
    class SliderViewHolder(itemView: View?) : SliderViewAdapter.ViewHolder(itemView) {
        ...
        var BtnLanjut : Button = itemView!!.findViewById(R.id.BtnLanjut)
